  ...
  return (
    <AnimatePresence>
      ...
      >
        <motion.div
          ref={modalRef}
          className="bg-[#111827] border border-[#1e2d45] rounded-t-2xl md:rounded-2xl w-full max-w-md max-h-[85vh] flex flex-col"
        ...
        >
          {showSuccess ? (
            <div className="flex flex-col items-center text-center py-8 p-5">
              <motion.svg
            ...
            <>
              ...
              <div className="hide-scrollbar overflow-y-auto flex-1 p-5" style={{ msOverflowStyle: 'none' } as React.CSSProperties}>
                ...
                <form id="showcase-form" onSubmit={handleSubmit(onSubmit)} className="space-y-3">
                  {apiError && (
                    <div className="bg-[#450a0a] border border-[#ef4444] text-[#fca5a5] text-sm rounded-lg p-3 mb-3">
                      {apiError}
                    </div>
                  )}
              ...
              <div className="sticky bottom-0 bg-[#111827] pt-3 pb-5 px-5 border-t border-[#1e2d45]">
                <button
                  type="submit"
                  form="showcase-form"
